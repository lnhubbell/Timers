...
def _install_supervisor():
    ...
    # )
    sudo('mv /home/ubuntu/Timers/app/deploy/supervisord.conf /etc/supervisor/conf.d/Timers.conf')
...
def _move_nginx_files():
    ...
    sudo('mv /home/ubuntu/Timers/app/deploy/simple_nginx_config /etc/nginx/sites-available/default')
...
def _mass_install():
    ...
    with settings(warn_only=True):
        sudo('pip install -r Timers/requirements.txt')
...
def _install_app():
    # sudo('mv Timers/setup.py setup.py')
    sudo('python /home/ubuntu/Timers/manage.py runserver')
